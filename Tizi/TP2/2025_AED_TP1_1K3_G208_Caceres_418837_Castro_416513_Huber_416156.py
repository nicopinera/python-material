...
def validar_destinatario(id_destinatario):
    ...
    return all(c in caracteres_validos for c in id_destinatario) and id_destinatario != ''
                ...
                if moneda is None:
                    ...
                    for m in ['ARS', 'USD', 'EUR', 'GBP', 'JPY']:
                        if m in codigo_orden:
                            if m == 'ARS': cant_ARS += 1
                            elif m == 'USD': cant_USD += 1
                            elif m == 'EUR': cant_EUR += 1
                            elif m == 'GBP': cant_GBP += 1
                            elif m == 'JPY': cant_JPY += 1
                            break
                else:
